...
export default function DeckStatsPage() {
  ...
  const { data: reviewDistribution } =
    api.study.getDeckReviewDistribution.useQuery({
      deckId,
      period: selectedPeriod,
    });
  ...
  const prepareCardTypeData = () => {
    ...
    const basicCards = deck.cards.filter(
      (card: { card_type: string }) => card.card_type === "BASIC",
    ).length;
    const clozeCards = deck.cards.filter(
      (card: { card_type: string }) => card.card_type === "CLOZE",
    ).length;
    ...
    <div className="container mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="mb-6 lg:mb-8">
        ...
        <div className="space-y-1">
          <h1 className="flex items-center gap-2 text-xl font-semibold tracking-tight sm:text-2xl lg:text-2xl">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">
                  {deckStats?.totalTimeMinutes
                    ? `${Math.round(deckStats.totalTimeMinutes)}m`
                    : "0m"}
                </p>
              </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="outline">
                    {deckStats?.averageResponseTime
                      ? `${Math.round(deckStats.averageResponseTime / 1000)}s`
                      : "0s"}
                  </Badge>
                </div>
                <div className="flex items-center justify-between">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium">
                      {deckStats?.bestStreak ?? 0} days
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm">Study Days</span>
                    <span className="text-sm font-medium">
                      {deckStats?.studyDays ?? 0} days
                    </span>
                  </div>
                </div>
              </CardContent>
                  ...
                  {(deckStats?.accuracy ?? 0) < 70 && (
                    <div className="rounded-lg bg-red-50 p-3">
                      ...
                      <p className="text-sm text-red-700">
                        Your accuracy is below 70%. Consider reviewing difficult
                  ...
                  {(deckStats?.currentStreak ?? 0) === 0 && (
                    <div className="rounded-lg bg-blue-50 p-3">
                      ...
                      <p className="text-sm text-blue-700">
                        Start studying daily to build a consistent learning
                        habit.
                      </p>
                    </div>
                  )}
                  {(deckStats?.totalReviews ?? 0) < 10 && (
                    <div className="rounded-lg bg-purple-50 p-3">
                      ...
                      <p className="text-sm text-purple-700">
                        You&apos;re just getting started! Try to complete at
                        least 10 reviews to see your progress.
                      </p>
                    </div>
                  )}
                  {(deckStats?.accuracy ?? 0) >= 90 &&
                    (deckStats?.currentStreak ?? 0) >= 7 && (
                      <div className="rounded-lg bg-green-50 p-3">
                        ...
                        <p className="text-sm text-green-700">
                          You&apos;re doing great! Keep up the consistent study
                          habit.
                        </p>
                      </div>
                    )}
