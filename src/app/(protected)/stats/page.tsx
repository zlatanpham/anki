...
export default function StatisticsPage() {
  ...
  const performanceData = studyStats
    ? [
        {
          name: "Again",
          value: studyStats.ratingBreakdown.AGAIN,
          color: "#ef4444",
        },
        {
          name: "Hard",
          value: studyStats.ratingBreakdown.HARD,
          color: "#f97316",
        },
        {
          name: "Good",
          value: studyStats.ratingBreakdown.GOOD,
          color: "#22c55e",
        },
        {
          name: "Easy",
          value: studyStats.ratingBreakdown.EASY,
          color: "#3b82f6",
        },
      ]
    : [];
  ...
  const cardStateData = dueCardsCount
    ? [
        ...
        {
          name: "Learning",
          value: dueCardsCount.learningCards,
          color: "#f59e0b",
        },
    ...
    <div className="container mx-auto max-w-7xl px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
      ...
      >
        <div className={cn("flex items-center gap-2", isMobile && "flex-1")}>
          ...
          >
            <SelectTrigger className={cn(isMobile ? "min-w-0 flex-1" : "w-32")}>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        <div className={cn("flex items-center gap-2", isMobile && "flex-1")}>
          ...
          <Select value={selectedDeck} onValueChange={setSelectedDeck}>
            <SelectTrigger className={cn(isMobile ? "min-w-0 flex-1" : "w-48")}>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
      ...
      {/* Key Metrics */}
      <div
        className={`mb-4 grid grid-cols-2 gap-3 transition-opacity duration-200 sm:mb-6 sm:gap-6 md:grid-cols-2 lg:grid-cols-4 ${
      ...
      >
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 px-3 pb-2 sm:px-6">
            ...
            <Target className="text-muted-foreground h-3 w-3 sm:h-4 sm:w-4" />
          </CardHeader>
          <CardContent className="px-3 sm:px-6">
            <div className="text-xl font-bold sm:text-2xl">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 px-3 pb-2 sm:px-6">
            ...
            <Flame className="text-muted-foreground h-3 w-3 sm:h-4 sm:w-4" />
          </CardHeader>
          <CardContent className="px-3 sm:px-6">
            <div className="text-xl font-bold sm:text-2xl">
        ...
        <Card>
          ...
          <CardContent className="px-3 sm:px-6">
            <div className="text-xl font-bold sm:text-2xl">
              {studyStats?.averageResponseTime
                ? Math.round(studyStats.averageResponseTime / 1000)
                : 0}
              s
            </div>
            <p className="text-muted-foreground text-xs">per card</p>
          </CardContent>
        </Card>
      </div>
      ...
      >
        <div className={cn("overflow-x-auto", isMobile && "-mx-4 px-4")}>
          <TabsList
            className={cn(
        ...
        <TabsContent value="activity" className="space-y-6">
          <div className="grid gap-6 lg:grid-cols-2">
            <Card>
              ...
              <CardContent
                className={cn(isMobile ? "px-1 sm:px-6" : "px-2 sm:px-6")}
              >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-muted-foreground text-sm">
                          {studyStats?.totalReviews
                            ? Math.round(
                                (item.value / studyStats.totalReviews) * 100,
                              )
                            : 0}
                          %
                        </span>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3 rounded-lg bg-green-50 p-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700">
                      Your accuracy rate of {studyStats?.accuracy ?? 0}% shows
                      excellent retention.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 rounded-lg bg-blue-50 p-4">
                  <Flame className="mt-0.5 h-5 w-5 text-blue-600" />
                  <div>
                    <p className="font-medium text-blue-800">
                      Consistency Streak
                    </p>
                    <p className="text-sm text-blue-700">
                      You&apos;ve studied for {studyStats?.studyStreak ?? 0}{" "}
                ...
                {studyStats?.averageResponseTime &&
                  studyStats.averageResponseTime > 5000 && (
                    <div className="flex items-start gap-3 rounded-lg bg-yellow-50 p-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-yellow-700">
                          Consider reviewing cards more quickly to improve your
                          recall speed.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-start gap-3 rounded-lg bg-purple-50 p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-purple-700">
                        You have {dueCardsCount.totalDue} cards ready for
                        review. Perfect time to study!
                      </p>
                ...
                <div className="flex items-start gap-3 rounded-lg bg-indigo-50 p-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-indigo-700">
                      Aim for 20-30 reviews per day for optimal spaced
                      repetition benefits.
                    </p>
                  </div>
                </div>
