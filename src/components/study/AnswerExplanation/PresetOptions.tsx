...
const presetOptions: PresetOption[] = [
  {
    ...
    icon: Baby,
    color: "text-blue-600 hover:text-blue-700 hover:border-blue-300 focus-visible:border-blue-400 focus-visible:ring-blue-200",
  ...
  },
  {
    ...
    icon: Lightbulb,
    color: "text-green-600 hover:text-green-700 hover:border-green-300 focus-visible:border-green-400 focus-visible:ring-green-200",
  ...
  },
  {
    ...
    icon: Target,
    color: "text-purple-600 hover:text-purple-700 hover:border-purple-300 focus-visible:border-purple-400 focus-visible:ring-purple-200",
  ...
  },
  {
    ...
    icon: Layers,
    color: "text-orange-600 hover:text-orange-700 hover:border-orange-300 focus-visible:border-orange-400 focus-visible:ring-orange-200",
